# AI Agent Instructions for Alok's Portfolio

## Reference
This project relies on `AGENTS.md` for Next.js specific framework rules. Please read `AGENTS.md` for Next.js App Router rules.
